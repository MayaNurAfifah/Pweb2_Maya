...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Pertenakan Dashboard - Forms</title>
    <link
      ...
      <div class="flex flex-col flex-1">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <form action="/updatedataternak{{$data->id}}" method="POST" enctype="multipart/form-data">
              @csrf
            <div
            ...
            <label class="block text-sm">
              <span class="text-gray-700 dark:text-gray-400">
                Tanggal</span>
              <input type="date" class="block w-full mt-1 text-sm border-blue-600 dark:text-gray-300 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue form-input" class="form-control""
              ...
              {{-- <label class="block mt-4 text-sm">
                <div>
                  <button class="w-20 btn btn-lg btn-primary"
